...
function cargarVP_equipos() {
    ...
    $("#div_TablaEquipos").load("/Gestion/Actualizador/cargarVP_Equipos", function (responseTxt, statusTxt, xhr) {
...
function cargarVP_jugadores() {
    ...
    $("#divTablaJugadores").load("/Gestion/Actualizador/cargarVP_Jugadores", function (responseTxt, statusTxt, xhr) {
        if (statusTxt === "success") {
